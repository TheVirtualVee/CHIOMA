export const EVENT_TYPES = {
  ...
  EMPLOYER_ONBOARDING_STARTED: "EMPLOYER_ONBOARDING_STARTED",
  BUSINESS_PROFILE_DEFINED: "BUSINESS_PROFILE_DEFINED",
  BUSINESS_HOURS_DEFINED: "BUSINESS_HOURS_DEFINED",
  ESCALATION_CONTACT_REGISTERED: "ESCALATION_CONTACT_REGISTERED",
  TONE_PROFILE_DEFINED: "TONE_PROFILE_DEFINED",
  HIGH_VALUE_ITEM_DEFINED: "HIGH_VALUE_ITEM_DEFINED",
  ONBOARDING_COMPLETED: "ONBOARDING_COMPLETED",
  EMPLOYER_MARKED_AWAY: "EMPLOYER_MARKED_AWAY",
  AWAY_MODE_EXITED: "AWAY_MODE_EXITED",
